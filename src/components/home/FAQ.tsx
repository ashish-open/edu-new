...
const defaultFAQs: FAQItem[] = [
  {
    ...
    answer: "Eligibility criteria vary by course. Generally, for undergraduate programs, you need to have completed 10th or +2 with relevant subjects (Physics, Chemistry, Biology for medical courses). Please check the specific course page for detailed eligibility requirements.",
  },
  {
    id: 2,
