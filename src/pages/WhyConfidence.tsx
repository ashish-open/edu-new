    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-muted">
          <div className="container mx-auto px-4 max-w-[1220px]">
            <h2 className="text-3xl md:text-4xl font-zonapro font-hairline text-secondary mb-12 text-center">
              Our Achievements
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-4xl md:text-5xl font-zonapro font-bold text-primary mb-2">100%</p>
                <p className="text-sm font-zonapro text-muted-foreground">Placement Support</p>
              </div>
              <div>
                <p className="text-4xl md:text-5xl font-zonapro font-bold text-accent mb-2">500+</p>
                <p className="text-sm font-zonapro text-muted-foreground">Students Placed</p>
              </div>
              <div>
                <p className="text-4xl md:text-5xl font-zonapro font-bold text-orange mb-2">15+</p>
                <p className="text-sm font-zonapro text-muted-foreground">Programs Offered</p>
              </div>
              <div>
                <p className="text-4xl md:text-5xl font-zonapro font-bold text-secondary mb-2">2</p>
                <p className="text-sm font-zonapro text-muted-foreground">Modern Campuses</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 max-w-[1220px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="p-6">
                  <div className="text-4xl font-zonapro font-bold text-primary mb-3">01</div>
                  <h3 className="text-xl font-zonapro font-hairline mb-2">Quality Education</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-4xl font-zonapro font-bold text-accent mb-3">02</div>
                  <h3 className="text-xl font-zonapro font-hairline mb-2">Skill Development</h3>
                  <p className="text-sm font-zonapro text-muted-foreground">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-4xl font-zonapro font-bold text-orange mb-3">03</div>
                  <h3 className="text-xl font-zonapro font-hairline mb-2">Career Support</h3>
                  <p className="text-sm font-zonapro text-muted-foreground">
